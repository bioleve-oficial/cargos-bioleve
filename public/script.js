const data = {
  administracao: {
    ...
    "DIS Coord Riberão Preto": [
      {nome: "Consultor Comercial", descricao: "Responder pelas atividades de consultoria, em assuntos referentes à área Comercial, compreendendo: diagnósticos, planejamento estratégico de atuação, desenvolvimento dos trabalhos, propondo alternativas e soluções à Direção da empresa.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "}
    ],
    "DIS Coord Televendas": [
      {nome: "Auxiliar de Vendas", descricao: "Auxiliar em atividades relativas à área de Vendas, tais como: elaboração de levantamentos de informações e dados para controle sobre as vendas realizadas, bem como para emissão de relatórios específicos de sua área de atuação, contendo vendas realizadas, período, quantidades, segmentos, etc.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "}
    ],
    "DIS Coord Varejo Litoral Sul ": [
      {nome: "Supervisor Comercial", descricao: "Supervisionar a rotina da equipe de vendas, avalia os profissionais de vendas de produtos e serviços, apresentam à gerência os resultados das metas, cria o planejamento de vendas e atende a clientes. Coleta e acompanha o indicador do mercado consumidor.", competencia: "Cultura De Segurança; Flexibilidade; Iniciativa; Visão Do Negocio; Trabalho Em Equipe; Gestão Do Conhecimento; Liderança;"},
      {nome: "Consultor Comercial", descricao: "Responder pelas atividades de consultoria, em assuntos referentes à área Comercial, compreendendo: diagnósticos, planejamento estratégico de atuação, desenvolvimento dos trabalhos, propondo alternativas e soluções à Direção da empresa.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "},
      {nome: "Coordenador Comercial", descricao: "Coordenar as atividades voltadas ao comportamento do mercado e produtos da empresa, tais como: análises de estratégias e atividades da concorrência. Elaboração de relatórios gerenciais, identificar e apontar tendências mercadológicas, bem como elaborar e analisar projeções e quadros comparativos, para subsidiar a gerência na tomada de decisão e assegurar a venda dos produtos em condições que atendam os resultados previstos.", competencia: "Cultura De Segurança; Trabalho Em Equipe; Gestão Do Conhecimento; Liderança; Visão Sistemica; Gestão Do Desempenho. "}
    ],
    "DIS Coord Varejo São Paulo ": [
      {nome: "Consultor Comercial", descricao: "Responder pelas atividades de consultoria, em assuntos referentes à área Comercial, compreendendo: diagnósticos, planejamento estratégico de atuação, desenvolvimento dos trabalhos, propondo alternativas e soluções à Direção da empresa.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "}
    ],
    "DIS Coord São José dos Campos ": [
      {nome: "Consultor Comercial", descricao: "Responder pelas atividades de consultoria, em assuntos referentes à área Comercial, compreendendo: diagnósticos, planejamento estratégico de atuação, desenvolvimento dos trabalhos, propondo alternativas e soluções à Direção da empresa.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "},
      {nome: "Coordenador Comercial", descricao: "Coordenar as atividades voltadas ao comportamento do mercado e produtos da empresa, tais como: análises de estratégias e atividades da concorrência. Elaboração de relatórios gerenciais, identificar e apontar tendências mercadológicas, bem como elaborar e analisar projeções e quadros comparativos, para subsidiar a gerência na tomada de decisão e assegurar a venda dos produtos em condições que atendam os resultados previstos.", competencia: "Cultura De Segurança; Trabalho Em Equipe; Gestão Do Conhecimento; Liderança; Visão Sistemica; Gestão Do Desempenho. "}
    ],
    "Gerencia de Distribuidores ": [
      {nome: "Gerente Regional de Vendas", descricao: "Gerenciar as atividades de controle das vendas realizadas pelas filiais, definindo cotas de vendas, baseando-se no porte de cada região e produção da empresa, com o objetivo de atingir metas estabelecidas. Elaborar planos estratégicos das áreas de comercialização, marketing e comunicação. Implementar atividades e coordenar sua execução. Gerenciar recursos humanos, materiais e financeiros.", competencia: "Cultura De Segurança; Liderança; Visão Sistemica; Planejamento De Futuro; Gestão De Mudanças; Gestão Estratégica; "}
    ],
    "Expedição Faturamento CD ": [
      {nome: "Operador de Empilhadeira", descricao: "Operar máquina empilhadeira, a fim de transportar, empilhar e armazenar produtos, materiais diversos, caixas e outras cargas, em depósitos, armazéns e outros locais da empresa, observando as normas de segurança. Efetuar o carregamento e/ou descarregamento de caminhões. Zelar pela manutenção e conservação da empilhadeira, lavando-a, lubrificando-a, abastecendo-a e providenciando reparos sempre que necessário.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "},
      {nome: "Coordenador de Logística", descricao: "Coordenar e planejar o fornecimento e o controle de materiais produtivos e improdutivos da empresa. Desenvolver novos fornecedores e fontes alternativas de materiais e/ou insumos, objetivando a qualidade e o custo dos produtos. Participar do planejamento, programação e controle de produção.", competencia: "Cultura De Segurança; Trabalho Em Equipe; Gestão Do Conhecimento; Liderança; Visão Sistemica; Gestão Do Desempenho. "},
      {nome: "Assistente de Logistica ", descricao: "Realizar atividades administrativas do Setor, participar no desenvolvimento de estudos e implantação de alternativas de logística, visando adequação de prazos e redução de custos. Emitir CTRC's das cargas, observando todas as informações necessárias para a correta emissão do documento. Elaborar roteiros de entrega de materiais, otimizando os processos de movimentação e armazenagem de materiais e produtos.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "}
    ],
    "Fiscal ": [
      {nome: "Analista Fiscal", descricao: "Elaborar relatórios de análise pertinentes a área, participar na análise da legislação fiscal. Providenciar para que a empresa disponha de toda a literatura específica e manter contato, quando necessário, com repartições públicas para solucionar problemas surgidos em função da aplicação de novas leis.", competencia: "Cultura De Segurança; Flexibilidade; Iniciativa; Visão Do Negocio; Trabalho Em Equipe; Gestão Do Conhecimento."}
    ],
    "Fiscal ": [
      {nome: "Assistente de Marketing ", descricao: "Executar atividades administrativas do departamento de marketing, relacionadas ao preparo e distribuição de material promocional. Levantar dados de anuários ou outras fontes, para fins de pesquisas mercadológicas. Contatar empresas de publicidade para a elaboração de anúncios promocionais.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "}
    ],
    "Promotores ": [
      {nome: "Promotor de Vendas", descricao: "Divulgar a linha de produtos da empresa, mantendo contato frequente com os clientes, visando aumentar o volume de vendas e absorver clientes potenciais.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "}
    ],
    "GC Gerencia Nacional ": [
      {nome: "Gerente Nacional de Grandes Contas", descricao: "Cultivar relações sólidas com clientes estratégicos, identificar oportunidades de vendas, oferecer soluções personalizadas, coordenar projetos, monitorar o desempenho das contas, conduzir negociações e coletar feedback para melhorias contínuas. Esse papel é crucial para alinhar os objetivos da empresa às necessidades dos clientes, promovendo um crescimento mútuo e sustentável.", competencia: "Cultura De Segurança; Liderança; Visão Sistemica; Planejamento De Futuro; Gestão De Mudanças; Gestão Estratégica; "}
    ],
    "GC Coord EQ ABC Jundiai": [
      {nome: "Coordenador Comercial", descricao: "Coordenar as atividades voltadas ao comportamento do mercado e produtos da empresa, tais como: análises de estratégias e atividades da concorrência. Elaboração de relatórios gerenciais, identificar e apontar tendências mercadológicas, bem como elaborar e analisar projeções e quadros comparativos, para subsidiar a gerência na tomada de decisão e assegurar a venda dos produtos em condições que atendam os resultados previstos.", competencia: "Cultura De Segurança; Trabalho Em Equipe; Gestão Do Conhecimento; Liderança; Visão Sistemica; Gestão Do Desempenho. "}
    ],
    "GC Coord EQ Piracicaba": [
      {nome: "Coordenador Comercial", descricao: "Coordenar as atividades voltadas ao comportamento do mercado e produtos da empresa, tais como: análises de estratégias e atividades da concorrência. Elaboração de relatórios gerenciais, identificar e apontar tendências mercadológicas, bem como elaborar e analisar projeções e quadros comparativos, para subsidiar a gerência na tomada de decisão e assegurar a venda dos produtos em condições que atendam os resultados previstos.", competencia: "Cultura De Segurança; Trabalho Em Equipe; Gestão Do Conhecimento; Liderança; Visão Sistemica; Gestão Do Desempenho. "}
    ], 
    "GC Coord EQ Vale do Paraiba": [
      {nome: "Consultor Comercial", descricao: "Responder pelas atividades de consultoria, em assuntos referentes à área Comercial, compreendendo: diagnósticos, planejamento estratégico de atuação, desenvolvimento dos trabalhos, propondo alternativas e soluções à Direção da empresa.", competencia: "Cultura De Segurança; Disciplina; Flexibilidade; Iniciativa; Visão Do Negocio; "}
    ]
  },
